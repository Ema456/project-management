...
class Blog(models.Model):
    ...
    Remaks_one = models.TextField(null=True, blank=True)
    Remaks_two = models.TextField(null=True, blank=True)
    Remaks_three = models.TextField(null=True, blank=True)
    Remaks_four = models.TextField(null=True, blank=True)
    Remaks_five = models.TextField(null=True, blank=True)
